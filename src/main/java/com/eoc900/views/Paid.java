...
public class Paid {
    ...
    public Paid(JFrame window, Controller nav, int total) {
        this.frame = window;
        this.navigation = nav;
        setNumber(total);
    }
    ...
    public JPanel displaySearchByName() {
        ...
        title = new JLabel("Hay " + countPendingPayments + " cuentas pagadas");
    ...
    public JPanel displayTablePayments(String[][] data) {
    ...
    public void searchByNameEvents() {
        buscar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                db.init(false);
                String[][] accounts = Multidimentional.removeArrayNullValues(db.getPaidAccountByPatientName(patient),
                        4);
